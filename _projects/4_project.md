---
layout: page
title: Citi Bike Analytics Pipeline
description: End-to-end data pipeline and analytics on NYC Citi Bike trips
img: assets/img/citi-bike-analytics.jpg
importance: 1
category: work
related_publications: false
---

![Citi Bike Analytics Pipeline](https://github.com/kachiann/kachiann.github.io/blob/master/assets/img/citi-bike-analytics.jpg)
...
Explore the full pipeline, including ingestion, transformation, and analytics code, in the [GitHub repository](https://github.com/kachiann/citi-bike-analytics-pipeline).
